...
variable "owner" {
  description = "Team accountable for the dev environment."
  type        = string
  default     = "platform-team"
}

variable "cost_center" {
  description = "Cost allocation code for the dev environment."
  type        = string
}

variable "vpc_cidr" {
  description = "CIDR block for the dev VPC. Use an RFC 1918 documentation range."
  type        = string
...
# bootstrap outputs to grant the dev CI role scoped state access; leave null to
# skip it.
